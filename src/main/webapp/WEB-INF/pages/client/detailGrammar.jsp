			...
			<div class="span9">
				<div class="blog-post">
					...
					<div class="postmetadata">
						<ul>
							<li><i class="icon-user"></i> <a href="#">Ám ảnh Toeic</a></li>
							<li><i class="icon-calendar"></i><a href="#">July, 2022</a></li>
							<li><i class="icon-comment"></i> <a href="#"> ${countCmt}
									Comments </a></li>
						</ul>
					</div>
					<img
						src="${pageContext.request.contextPath}/resources/file/images/grammar.jpg"
