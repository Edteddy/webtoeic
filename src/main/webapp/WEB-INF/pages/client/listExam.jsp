			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img style="float: left"
						src="${pageContext.request.contextPath}\resources\file\images\listening.jpg"> <br>
					<p>&nbsp Phần 1: Listening skills (45 phút - 50 câu hỏi)</p>
					<br> <img style="float: left"
						src="${pageContext.request.contextPath}\resources\file\images\reading.jpg"> <br>
					<p>&nbsp Phần 2: Reading skills (75 phút - 50 câu hỏi)</p>
